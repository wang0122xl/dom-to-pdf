 ...
 * @LastEditTime: 2022-06-29 14:36:16
...
const App = () => {
    ...
    const _getPdfs = async () => {
        ...
        const pdfs = await domToPdf.transformToPdfs({
            ...
            renderPageFooter: async (pdf, currentPage, total) => {
                pdf
                    .setTextColor('#111')
                    .setFontSize(8)
                    .text(`第${currentPage}页, 共${total}页`, pdf.internal.pageSize.getWidth() - 17, pdf.internal.pageSize.getHeight() - 1)
            },
        })
        return pdfs
    }
